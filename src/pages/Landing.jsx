...
export default function Landing() {
  return (
    <div className="min-h-screen bg-background text-foreground">
      <header
        className="border-b border-border/60 bg-background/90 backdrop-blur sticky top-0 z-30"
      ...
      <main>
        <section className="max-w-6xl mx-auto px-4 sm:px-6 pt-16 sm:pt-24 pb-14 sm:pb-20">
          <div className="max-w-3xl">
            ...
            <h1 className="text-5xl sm:text-7xl font-black tracking-tight leading-[0.98]">
              Top 7
            </h1>
            <p className="mt-3 text-xl sm:text-2xl font-bold tracking-tight">
              Running training for athletes and coaches.
            </p>
