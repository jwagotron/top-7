      ...
      <div className="flex items-center gap-1 shrink-0 z-10 mb-1">
        ...
        {showAddButton && (
          <button
            ...
            className="opacity-100 sm:opacity-0 sm:group-hover:opacity-100 w-3 h-3 rounded-full bg-primary/20 hover:bg-primary/40 flex items-center justify-center transition-all duration-200 shrink-0"
          >
            ...
            <div
              ...
              className={cn(
                'flex items-center gap-0.5 px-1.5 py-1 rounded-md text-[8px] font-semibold transition-all duration-200 truncate max-w-[90%] whitespace-nowrap flex-shrink-0',
                  ...
                  : skipped
                  ? 'bg-slate-600/50 text-slate-300 line-through'
                  : color,
              )}
